...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.splitter.setGeometry(QtCore.QRect(-1, -1, 801, 561))
        ...
        self.radioButton.setGeometry(QtCore.QRect(80, 220, 131, 30))
        self.radioButton.setObjectName("radioButton")
        self.comboBox = QtWidgets.QComboBox(self.frame)
        self.comboBox.setGeometry(QtCore.QRect(90, 120, 95, 31))
        self.comboBox.setObjectName("comboBox")
        self.comboBox.addItem("")
        self.comboBox.addItem("")
        self.comboBox.addItem("")
        self.Resolution = QtWidgets.QSlider(self.frame)
        self.Resolution.setGeometry(QtCore.QRect(80, 310, 160, 16))
